...
function Sidebar(props) {
  ...
  const handleWardwiseCitizenDownload = () => {
    updateSideKey(3, selectedWard, selectedHealthPost, selectedDispensary, selectedWardName);
  };
  const handleHealthPostwiseCitizenDownload = () => {
    updateSideKey(4, selectedWard, selectedHealthPost, selectedDispensary, selectedHealthPostName);
  };

  const handleDownloadAllCitizenList = () => {
    updateSideKey(2, selectedWard, selectedHealthPost, selectedDispensary, selectedWardName);
  };

  const handleDownloadDispensarywise = () => {
    updateSideKey(5, selectedWard, selectedHealthPost, selectedDispensary, selectedDispensaryName);
  };
